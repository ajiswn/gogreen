...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="#" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Go<span class="green">Green</span></span>
      </a>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright 2024<strong><span> Go<span style="color: #94CB3A;">Green</span></span></strong>. All Rights Reserved
    </div>
  </footer>
  <!-- End Footer -->

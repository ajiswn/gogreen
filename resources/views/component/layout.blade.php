      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 footer-contact">
            <h3>Go<span class="green">Green</span></h3>
            <p>
              ...
              Kab. Muaro Jambi <br>
              Jambi<br><br>
              <strong>Phone:</strong> +62 8123 45678 90<br>
              <strong>Email:</strong> gogreenunjaaa@gmail.com<br>
            </p>
          </div>
          ...
          <div class="col-lg-6 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="{{ url('/about_us') }}">Tentang Kami</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="{{ url('/article') }}">Artikel</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="{{ url('/register') }}">Pendaftaran</a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="container d-md-flex py-4">
      <div class="text-center">
        <div class="copyright align-items-center">
          &copy; Copyright 2024 <strong><span>Go<span class="green">Green</span></span></strong>. All Rights Reserved
        </div>
      </div>
    </div>
  </footer><!-- End Footer -->
